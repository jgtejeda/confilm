...
<title>Mensaje administrativo — Comisión Film</title>
</head>
              ...
              <tr>
                <td style="padding:40px 40px 36px;">
                  ...
                  <p style="margin:0 0 28px;font-size:14px;color:rgba(245,240,232,0.55);text-align:center;line-height:1.6;">
                    ...
                    Has recibido el siguiente mensaje del equipo administrativo.
                  </p>
                  ...
                  <table width="100%" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                      <td style="padding:20px 24px;">
                        <div style="font-size:14px;color:rgba(245,240,232,0.75);line-height:1.7;">
                          <?= $body ?>
                        </div>
                      </td>
                    </tr>
              ...
              <tr>
                <td style="padding:20px 40px;text-align:center;">
                  <p style="margin:0;font-size:11px;color:rgba(245,240,232,0.3);line-height:1.6;">
                    Este es un mensaje enviado por el equipo administrativo.<br>
