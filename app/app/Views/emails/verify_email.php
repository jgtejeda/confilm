              ...
              <tr>
                <td style="padding:40px 40px 36px;">
                  ...
                  <p style="margin:0 0 28px;font-size:14px;color:rgba(245,240,232,0.55);text-align:center;line-height:1.6;">
                    ...
                    Haz clic en el botón para confirmar tu correo electrónico.
                  </p>
                  ...
                  <table width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                      <td align="center" style="padding-bottom:28px;">
                        <a href="<?= site_url('verificar/' . $token) ?>"
              ...
              <tr>
                <td style="padding:20px 40px;text-align:center;">
                  <p style="margin:0;font-size:11px;color:rgba(245,240,232,0.3);line-height:1.6;">
                    Este enlace expira en <strong style="color:rgba(245,240,232,0.45);">24 horas</strong>.<br>
