...
<title>Inscripción rechazada — Comisión Film</title>
</head>
            ...
            <table width="100%" cellpadding="0" cellspacing="0">
              <tr>
                <td style="padding:40px 40px 36px;">
                  ...
                  <!-- Icon -->
                  <div style="text-align:center;font-size:42px;margin-bottom:20px;">⚠️</div>
                  ...
                  <p style="margin:0 0 28px;font-size:14px;color:rgba(245,240,232,0.55);text-align:center;line-height:1.6;">
                    ...
                    Lamentamos informarte que tu inscripción no pudo ser aprobada.
                  </p>
                  ...
                  <table width="100%" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                      <td style="padding:20px 24px;">
                        <div style="font-size:10px;letter-spacing:0.1em;text-transform:uppercase;color:rgba(240,180,180,0.6);margin-bottom:4px;">Motivo</div>
                        <div style="font-size:14px;color:rgba(245,240,232,0.75);line-height:1.6;">
                          <?= esc($inscription['rejection_note'] ?? 'No se proporcionó un motivo.') ?>
                        </div>
                      </td>
                    </tr>
                  </table>
              ...
              <tr>
                <td style="padding:20px 40px;text-align:center;">
                  <p style="margin:0;font-size:11px;color:rgba(245,240,232,0.3);line-height:1.6;">
                    Si tienes dudas, contáctanos a través del sistema.<br>
