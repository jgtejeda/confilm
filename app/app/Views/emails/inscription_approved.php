...
<title>¡Inscripción aprobada! — Comisión Film</title>
</head>
              ...
              <tr>
                <td style="padding:40px 40px 36px;">
                  ...
                  <h1 style="margin:0 0 10px;font-size:26px;font-weight:600;color:#f5f0e8;text-align:center;font-family:Georgia,serif;letter-spacing:-0.02em;">
                    ¡Felicidades, <?= esc($user['nombres'] ?? $user['username'] ?? 'usuario') ?>!
                  </h1>

                  <!-- Subtitle -->
                  <p style="margin:0 0 28px;font-size:14px;color:rgba(245,240,232,0.55);text-align:center;line-height:1.6;">
                    Tu inscripción ha sido <strong style="color:#b4f0c8;">aprobada</strong>.<br>
                    Ya eres parte de la Comisión Film México.
                  </p>
                  ...
                  <table width="100%" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                      <td style="padding:20px 24px;text-align:center;">
                        <p style="margin:0;font-size:15px;color:rgba(180,240,200,0.9);line-height:1.6;">
                          Tu registro está completo y activo.<br>
              ...
              <tr>
                <td style="padding:20px 40px;text-align:center;">
                  <p style="margin:0;font-size:11px;color:rgba(245,240,232,0.3);line-height:1.6;">
                    Bienvenido a la comunidad de la Comisión Film.<br>
