...
<title>Documento aprobado — Comisión Film</title>
</head>
              ...
              <tr>
                <td style="padding:40px 40px 36px;">
                  ...
                  <p style="margin:0 0 28px;font-size:14px;color:rgba(245,240,232,0.55);text-align:center;line-height:1.6;">
                    ...
                    Tu documento ha sido verificado y aprobado exitosamente.
                  </p>

                  <!-- Document info box -->
                  <table width="100%" cellpadding="0" cellspacing="0"
                         style="background-color:rgba(40,160,80,0.08);border:1px solid rgba(40,160,80,0.2);border-radius:10px;margin-bottom:28px;">
                    <tr>
                      <td style="padding:20px 24px;">
                        <div style="font-size:10px;letter-spacing:0.1em;text-transform:uppercase;color:rgba(180,240,200,0.6);margin-bottom:4px;">Tipo de documento</div>
                        <div style="font-size:17px;font-weight:600;color:#b4f0c8;letter-spacing:0.02em;">
                          <?= esc($docTypeName) ?>
                        </div>
                        <div style="margin-top:12px;padding-top:12px;border-top:1px solid rgba(245,240,232,0.06);">
                          <div style="font-size:10px;letter-spacing:0.1em;text-transform:uppercase;color:rgba(180,240,200,0.6);margin-bottom:4px;">Estado</div>
                          <div style="font-size:17px;font-weight:600;color:#b4f0c8;letter-spacing:0.02em;">
                            Aprobado
                          </div>
                        </div>
              ...
              <tr>
                <td style="padding:20px 40px;text-align:center;">
                  <p style="margin:0;font-size:11px;color:rgba(245,240,232,0.3);line-height:1.6;">
                    Si tienes alguna duda, contáctanos a través del sistema.<br>
